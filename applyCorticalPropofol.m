function output = applyCorticalPropofol(krishnanSpecification, decayTimeMultiplier, condMultiplier)
%APPLYCORTICALPROPOFOL - Apply adjustment factors for applying propofol GABA-Aergic changes for cortical-only model
%
% applyCorticalPropofol takes a (Krishnan et al., 2016)-type DynaSim model
